...
<tr>
	<td><input type="image" src="image/logout.jpg" width=90 value="로그아웃" onClick="logout()"></td>
	<td><input type="image" src="image/modify.jpg" width=90 value="내 정보 수정" onClick="goUpdate()"></td>
</tr>
</table>
<br><br><br>
<tr>
